# mn_traffic/traffic/qos_single_change_traffic.py
"""
S2 QoS Single Weight Change Traffic.
Sequential QoS measurement. Weight change at t=45s: [3,5,2] → [6,5,2].
QoS flows are phase-tagged (pre_change / post_change).
Duration: 120s.
"""
...
class QoSSingleChangeTrafficGenerator(BaseTrafficGenerator):
    ...
    def _run_traffic_pattern(self):
        ...
        while time.time() < deadline:
            ...
            # c1: QoS flow (sequential, phase-tagged)
...
def main():
    parser = get_base_parser("S2 QoS Single Weight Change")
    parser.add_argument("--results_dir", type=str, default=None)
    args = parser.parse_args()
    gen = QoSSingleChangeTrafficGenerator(
